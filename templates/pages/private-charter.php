    ...
    <div class="container form-shell">
        ...
        <form class="inquiry-form inquiry-form--light" action="/private-charter" method="post" data-inquiry-form>
            ...
            <div class="form-grid">
                ...
                <div class="field"><label for="departure_time">Estimated departure time <span aria-hidden="true">*</span></label><input id="departure_time" name="departure_time" type="time" step="300" required value="<?= $escape($old['departure_time'] ?? '') ?>"><?php if (isset($errors['departure_time'])): ?><small class="field-error"><?= $escape($errors['departure_time']) ?></small><?php endif; ?></div>
                ...
                <div class="field <?= ($old['journey_type'] ?? '') !== 'return' ? 'field--disabled' : '' ?>" data-return-field aria-disabled="<?= ($old['journey_type'] ?? '') !== 'return' ? 'true' : 'false' ?>"><label for="return_time">Estimated return time <span aria-hidden="true">*</span></label><input id="return_time" name="return_time" type="time" step="300" value="<?= $escape($old['return_time'] ?? '') ?>" <?= ($old['journey_type'] ?? '') !== 'return' ? 'disabled' : '' ?>><?php if (isset($errors['return_time'])): ?><small class="field-error"><?= $escape($errors['return_time']) ?></small><?php endif; ?></div>
